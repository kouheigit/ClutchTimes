...
Route::post('/home/vote', [App\Http\Controllers\HomeController::class, 'vote'])->name('auth.vote');

Route::post('/home/votepost', [App\Http\Controllers\HomeController::class,'votepost'])->name('auth.votepost');
