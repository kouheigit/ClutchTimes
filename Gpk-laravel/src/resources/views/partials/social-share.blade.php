...
<div class="flex items-center space-x-3">
    <span class="text-sm font-medium text-gray-700">シェアする:</span>
    <div class="flex space-x-2">
        <a href="https://twitter.com/intent/tweet?url={{ urlencode($url ?? request()->url()) }}&text={{ urlencode($title ?? '') }}" 
           target="_blank"
           class="p-2 bg-blue-400 text-white rounded-full hover:bg-blue-500">
        ...
        <a href="https://line.me/R/msg/text/?{{ urlencode(($title ?? '') . ' ' . ($url ?? request()->url())) }}" 
           target="_blank"
